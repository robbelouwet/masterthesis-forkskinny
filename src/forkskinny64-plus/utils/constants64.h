#ifndef FORKSKINNYPLUS64_CONSTANTS_H
#define FORKSKINNYPLUS64_CONSTANTS_H
...
Slice64_t forkskinny_precomputed_round_constants[88][7] = {
...
#endif //FORKSKINNYPLUS64_CONSTANTS_H
