...
static inline void forkskinny64_add_constant(State64Sliced_t *state, uint16_t iteration) {
	...
	#else
	// Cell 0 XOR C0
	state->cells[1].slices[0] = XOR_SLICE(state->cells[1].slices[0], forkskinny64_precomputed_round_constants[iteration][0]);
	state->cells[1].slices[1] = XOR_SLICE(state->cells[1].slices[1], forkskinny64_precomputed_round_constants[iteration][1]);
	state->cells[1].slices[2] = XOR_SLICE(state->cells[1].slices[2], forkskinny64_precomputed_round_constants[iteration][2]);
	state->cells[1].slices[3] = XOR_SLICE(state->cells[1].slices[3], forkskinny64_precomputed_round_constants[iteration][3]);
	
	// Cell 4 XOR C1
	state->cells[5].slices[0] = XOR_SLICE(state->cells[5].slices[0], forkskinny64_precomputed_round_constants[iteration][4]);
	state->cells[5].slices[1] = XOR_SLICE(state->cells[5].slices[1], forkskinny64_precomputed_round_constants[iteration][5]);
	state->cells[5].slices[2] = XOR_SLICE(state->cells[5].slices[2], forkskinny64_precomputed_round_constants[iteration][6]);
	#endif
