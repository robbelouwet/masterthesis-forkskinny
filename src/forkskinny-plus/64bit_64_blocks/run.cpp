...
void skinny_test(){
	// Set 64 state blocks, with only the first one containing A's
	auto state = Blocks64_t();
	state.values[0] = 0x3c3668e53d16c035; // 0x530c61d35e8663c3, 0x3c3668e53d16c035
	auto sliced_state = slice(state);
	
	// Set TK1
	auto tk1_blocks = Blocks64_t();
	tk1_blocks.values[0] = 0xb2dbb41b422dfcd0; // 0xed00c85b120d6861, 0x1686d021b58c00de
	auto sliced_TK1 = slice(tk1_blocks);
	
	// Set TK2
	auto tk2_blocks = Blocks64_t();
	tk2_blocks.values[0] = 0x06f809dfb42e3578; // 0x8753e24bfd908f60, 0x06f809dfb42e3578
	auto sliced_TK2 = slice(tk2_blocks);
	
	// Set TK3
	auto tk3_blocks = Blocks64_t();
	tk3_blocks.values[0] = 0xed00c85b120d6861; // 0xb2dbb41b422dfcd0, 0x0dcfd224b14bbd2b
	auto sliced_TK3 = slice(tk3_blocks);
