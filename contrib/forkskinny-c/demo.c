...
void demo_forkskinny_64_192() {
    ...
    forkskinny_c_64_192_encrypt(&tk1, &tk23, NULL, output_right_oneleg, message);

    // forward both legs
    uint8_t output_left[FORKSKINNY64_BLOCK_SIZE];
    uint8_t output_right[FORKSKINNY64_BLOCK_SIZE];
    forkskinny_c_64_192_encrypt(&tk1, &tk23, output_left, output_right, message);
...
void demo_forkskinny_128_256() {
    uint8_t key[2 * FORKSKINNY128_BLOCK_SIZE] = {0x29, 0xcd, 0xba, 0xab, 0xf2, 0xfb, 0xe3, 0x46, 0x7c, 0xc2, 0x54, 0xf8,
                                                 0x1b, 0xe8, 0xe7, 0x8d, 0x76, 0x5a, 0x2e, 0x63, 0x33, 0x9f, 0xc9, 0x9a,
                                                 0x66, 0x32, 0x0d, 0xb7, 0x31, 0x58, 0x80, 0x01};
...
void demo_forkskinny_128_384() {
    uint8_t key[3 * FORKSKINNY128_BLOCK_SIZE] = {0x29, 0xcd, 0xba, 0xab, 0xf2, 0xfb, 0xe3, 0x46, 0x7c, 0xc2, 0x54, 0xf8,
                                                 0x1b, 0xe8, 0xe7, 0x8d, 0x76, 0x5a, 0x2e, 0x63, 0x33, 0x9f, 0xc9, 0x9a,
                                                 0x66, 0x32, 0x0d, 0xb7, 0x31, 0x58, 0x80, 0x01, 0x29, 0xcd, 0xba, 0xab,
                                                 0xf2, 0xfb, 0xe3, 0x46, 0x7c, 0xc2, 0x54, 0xf8, 0x1b, 0xe8, 0xe7,
                                                 0x8d};
    uint8_t message[FORKSKINNY128_BLOCK_SIZE] = {0x67, 0xc6, 0x69, 0x73, 0x51, 0xff, 0x4a, 0xec, 0x80, 0x00, 0x00, 0x00,
                                                 0x00, 0x00, 0x00, 0x00};
