...
cmake --preset "debug-simd-flags" 1>/dev/null

# build the binary
cmake --build ./cmake-build-debug-simd &>/dev/null
if [ $? -eq 1 ]; then exit; fi

FILE="./cmake-build-debug-simd/forkskinnyplus"
if [ ! -e "$FILE" ]; then
